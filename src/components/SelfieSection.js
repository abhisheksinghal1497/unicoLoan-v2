...
export default function AdhaarSection({
  ...
  return (
    <View style={[styles.container]}>
      {uri ? (
        <>
          <View style={[styles.emptySection, childStyle && childStyle, {borderColor: getBorderColor()}]}>
            <Image source={{ uri }} style={[styles.imageContainer, {borderColor: getBorderColor()}]} />
          </View>
        </>
      ) : (
        <View style={[styles.emptySection, childStyle && childStyle, {borderColor: getBorderColor()}]}>
