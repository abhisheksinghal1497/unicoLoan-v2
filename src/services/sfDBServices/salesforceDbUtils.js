...
export const registerSoup = async (soupName, indexes) => {
    return new Promise((resolve, reject) => {
        smartstore.registerSoup(false, soupName, [...indexes], (result) => {
...
export const upsertSoupEntries = async (soupName, records) => {
    return new Promise((resolve, reject) => {
        smartstore.upsertSoupEntries(false, soupName, records, (data) => {
...
export const getAllSoupEntries = async (soupName, path) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            smartstore.querySoup(false, soupName, querySpec, (cursor) => {
...
export const clearAllSoupEntries = async (soupName) => {
    return new Promise(async (resolve, reject) => {
        try {
            smartstore.clearSoup(false, soupName, (resut) => {
                resolve(resut)
